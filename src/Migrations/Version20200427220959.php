...
final class Version20200427220959 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE mission (id INT NOT NULL, organization_id INT DEFAULT NULL, type_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, start TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, "end" TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX mission_start_end_idx ON mission (start, "end")');
        $this->addSql('COMMENT ON COLUMN mission.start IS \'(DC2Type:datetimetz_immutable)\'');
        $this->addSql('COMMENT ON COLUMN mission."end" IS \'(DC2Type:datetimetz_immutable)\'');
